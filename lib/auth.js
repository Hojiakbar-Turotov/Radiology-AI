...
class AuthManager {
  ...
  updateProfile(currentLogin, updates) {
    ...
    if (updates.workSchedule && typeof updates.workSchedule === 'object') {
      user.workSchedule = {
        start: updates.workSchedule.start || "08:00",
        end: updates.workSchedule.end || "17:00",
        lunchStart: updates.workSchedule.lunchStart || "12:00",
        lunchEnd: updates.workSchedule.lunchEnd || "13:00",
        days: Array.isArray(updates.workSchedule.days) ? updates.workSchedule.days : ["Dush", "Sesh", "Chor", "Pay", "Jum", "Shan"]
      };
    }

    // 6. Shaxsiy sozlamalar / tekshiruv vaqtlari
